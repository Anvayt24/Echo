...
def send_email(to, content):
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login('anvatrive2324@gmail.com', os.getenv('EMAIL_PASSWORD'))
...
def add_reminders(task):
    ...
    reminders.append(task)                                        # appending the file that is adding a new reminder to the list as task
